...
public class ESTest {
    ...
    public void createIndexStu() {
        ...
        Stu stu = new Stu();
        stu.setStuId(new Random(100000000).nextLong());
        stu.setName("superMan");
        stu.setAge(30);
        stu.setMoney(10*10f);
        stu.setSign("I am super man"+System.currentTimeMillis()/10000);
        stu.setDescription(" I'm quite rich man ");
...
//    ------------------------- 我是分割线 --------------------------------
    ...
    public void updateStuDoc() {
        ...
        sourceMap.put("sign", "I am super man");
        sourceMap.put("money", 99999999999999999999999.8f);
        sourceMap.put("age", 666);
...
//    ------------------------- 我是分割线 --------------------------------
    ...
    public void searchStuDoc() {
        ...
        SearchQuery query = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.matchQuery("description", "man rich"))
