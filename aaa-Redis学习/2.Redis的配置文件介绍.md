...
> **redis各种集群搭建方式的优缺点**
>
> https://www.jianshu.com/p/f0c01c528d8d

 ![image-20220828095552473](pictures/Untitled.assets/image-20220828095552473.png)

# 2、INCLUDES

 ![image-20220828095748584](pictures/Untitled.assets/image-20220828095748584.png)
...
# 3、MODULES
 ...
 ![image-20220828095830110](pictures/Untitled.assets/image-20220828095830110.png)

　　redis3.0的爆炸功能是新增了集群，而redis4.0就是在3.0的基础上新增了许多功能，其中这里的 自定义模块配置就是其中之一。通过这里的 loadmodule 配置将引入自定义模块来新增一些功能。

# 4、NETWORK

 ![image-20220828095950014](pictures/Untitled.assets/image-20220828095950014.png)
...
# 5、GENERAL
 ...
 ![image-20220828100027691](pictures/Untitled.assets/image-20220828100027691.png)
...
# 6、SNAPSHOTTING
 ...
 ![image-20220828100118297](pictures/Untitled.assets/image-20220828100118297.png)
...
# 7、REPLICATION
 ...
 ![image-20220828100218312](pictures/Untitled.assets/image-20220828100218312.png)
...
# 8、SECURITY
 ...
 ![image-20220828100325292](pictures/Untitled.assets/image-20220828100325292.png)
...
# 9、CLIENTS
 ...
 ![image-20220828100401189](pictures/Untitled.assets/image-20220828100401189.png)

# 10、MEMORY MANAGEMENT

 ![image-20220828100433179](pictures/Untitled.assets/image-20220828100433179.png)
...
# 11、APPEND ONLY MODE
 ...
 ![image-20220828100709568](pictures/Untitled.assets/image-20220828100709568.png)
...
# 12、LUA SCRIPTING
 ...
 ![image-20220828101103466](pictures/Untitled.assets/image-20220828101103466.png)

　　①、lua-time-limit：一个lua脚本执行的最大时间，单位为ms。默认值为5000.

# 13、REDIS CLUSTER

 ![image-20220828101137470](pictures/Untitled.assets/image-20220828101137470.png)
